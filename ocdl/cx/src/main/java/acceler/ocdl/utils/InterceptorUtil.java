...
public class InterceptorUtil extends WebMvcConfigurerAdapter {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(authInterceptor).addPathPatterns("/rest/**").excludePathPatterns("/rest/auth/login").excludePathPatterns("/rest/template/names").excludePathPatterns("/rest/template/templates").excludePathPatterns("/rest/data/upload").excludePathPatterns("/rest/projects");
